                        ...
                        foreach($program->kegiatans as $kegiatan) {
                            if($kegiatan->subkegiatans->isNotEmpty()) {
                                foreach($kegiatan->subkegiatans as $subkegiatan) {
                                    $anggaran_program += $subkegiatan->target_subkegiatan->anggaran;
                                }
                            }
                        }
                    ...
                    >
                        ...
                        <x-slot name="headerEnd">
                            ...
                            @php
                                ...
                                if($kegiatan->subkegiatans->isNotEmpty()) {
                                    foreach($kegiatan->subkegiatans as $subkegiatan) {
                                        $anggaran_kegiatan += $subkegiatan->target_subkegiatan->anggaran;
                                    }
                                }
                            ...
                            @foreach($kegiatan->subkegiatans as $subkegiatan)
                                ...
                                >
                                    ...
                                    <x-slot name="headerEnd">
                                        ...
                                        {{ Str::replace('IDR', 'Rp', format_money($subkegiatan->target_subkegiatan->anggaran, 'IDR')) }}
